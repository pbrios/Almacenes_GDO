...
public class ProductosListaAdapter extends RecyclerView.Adapter<ProductosListaAdapter.viewHolder> implements Filterable {
    ...
    */
    ...
    public ProductosListaAdapter(List<Productos> productosList, Context context) {
